...
/* TCP_DATA u config(unity:"2022.3.14f1";ver:"2.7.4";tmplt:"SG2_Template_URP";features:list["UNITY_5_4","UNITY_5_5","UNITY_5_6","UNITY_2017_1","UNITY_2018_1","UNITY_2018_2","UNITY_2018_3","UNITY_2019_1","UNITY_2019_2","UNITY_2019_3","UNITY_2020_1","UNITY_2021_1","OUTLINE","OUTLINE_URP_FEATURE","SPEC_PBR_GGX","SPECULAR","SPECULAR_SHADER_FEATURE","VERTEX_DISP_SHADER_FEATURE","BUMP_SHADER_FEATURE","OUTLINE_OPAQUE","TEMPLATE_LWRP","OUTLINE_CONSTANT_SIZE"];flags:list[];flags_extra:dict[];keywords:dict[RENDER_TYPE="Opaque",RampTextureDrawer="[TCP2Gradient]",RampTextureLabel="Ramp Texture",SHADER_TARGET="3.0"];shaderProperties:list[];customTextures:list[];codeInjection:codeInjection(injectedFiles:list[];mark:False);matLayers:list[]) */
/* TCP_HASH 50706b69afcde7b5fbd0bed94b102929 */
